...
public class PlayerResourceIT {
    ...
    private static final Integer DEFAULT_SHIRT_NUMBER = 1;
    private static final Integer UPDATED_SHIRT_NUMBER = 2;
    ...
    public static Player createUpdatedEntity(EntityManager em) {
        Player player = new Player()
            ...
            .shirtNumber(UPDATED_SHIRT_NUMBER)
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getShirtNumber()).isEqualTo(DEFAULT_SHIRT_NUMBER);
    ...
    public void updatePlayer() throws Exception {
        ...
        assertThat(testPlayer.getShirtNumber()).isEqualTo(UPDATED_SHIRT_NUMBER);
