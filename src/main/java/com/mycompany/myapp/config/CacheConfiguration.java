...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Region.class.getName() + ".leagues");
            createCache(cm, com.mycompany.myapp.domain.Sport.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Sport.class.getName() + ".leagues");
            createCache(cm, com.mycompany.myapp.domain.Sport.class.getName() + ".sports");
            ...
            createCache(cm, com.mycompany.myapp.domain.Match.class.getName() + ".gameEvents");
            createCache(cm, com.mycompany.myapp.domain.Match.class.getName() + ".scoreBoards");
            createCache(cm, com.mycompany.myapp.domain.Match.class.getName() + ".opportunities");
